...
Woman3::Woman3( MapPtr map, InfomationPtr info ) :
...
void Woman3::countLooking( ) {
	if ( isLooking( getPos( ) ) ) {
		_looking_time++;
	}
}

void Woman3::checkCollider( ) {
	// アスキーコードを取得
	int data = getMapData( getPos( ) + _distance );
